...
API_KEY = "0kvS50jnSMhOSqS7R4HPFPNPdLNG4zzGRaRziirQz9ab"
...
def predict1():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/c28806d8-d698-4b82-9fca-fce220173f2d/predictions?version=2022-01-20', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
